...
<html>
    <head>
        <title>Projeto Piloto PHP</title>
        <meta charset="UTF-8">
        ...
        <div class="topo">
            <div class="linha">
                ...
                <div class="coluna coluna6">
                    <h2>SISTEMAS PHP - Projeto Piloto</h2>
                    ...
                    <aside class="barra-lateral">
                        <nav class="menu">
                            <ul>
                                ...
                                <li><a href="#">Menu Z</a></li>
                            </ul>
                        </nav>
                    </aside>
                </div>
                <div class="coluna coluna8">
                    <div class="paginas">
                        teste
                       <!-- Conteúdo páginas --> 
                    </div>
        ...
        <div class="rodape">
            <div class="linha">
                <div class="coluna coluna12">
                    <font>Copyright &copy; IFTO. Todos os direitos reservados.</font>
                </div>
            </div>
        </div>
    </body>
