...
?>
			<div id="pagina"> 	
				...
				<form  class="formulario" method="post" action="index.php?p=relatorioderespostas&op=proximo">                
                   <table class="tabelas">
                        <tr>
	...
	?>
	 ...
	 <div id="pagina"> 	
             ...
             <h1 class="titulo1">Relatório de respostas por curso</h1>
             <form  class="formulario" method="post" action="index.php?p=relatorio_por_curso">                
                   <table class="tabelas">
                        <tr>
                            <th class="th276t">Seguimento:</th>
                            <td class="td700">
