...
<div id="pagina">
        ...
        <form name="verifica_radio" class="formulario" action="usuadm.php?pa=questionario_acao&acao=estudantes" method="post" enctype="multiparm/form-data" >              
...
<div id="pagina">
        ...
        <form name="verifica_radio" class="formulario" action="usuadm.php?pa=questionario_acao&acao=docentes" method="post" enctype="multiparm/form-data">              
...
<div id="pagina">
        ...
        <form name="verifica_radio" class="formulario" action="usuadm.php?pa=questionario_acao&acao=tec_adm" method="post" enctype="multiparm/form-data" >              
