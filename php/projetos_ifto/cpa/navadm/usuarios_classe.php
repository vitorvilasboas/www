...
class usuarios_classe 
  {
	  ...
	  {
	        $sql = "insert into usuarios (usu_nome,usu_cpf,usu_senha,usu_nivel,usu_email,usu_sexo,
                        usu_data_nasc,usu_celular,usu_telefone,usu_endereco,usu_numero,usu_cidade,
                        usu_uf,usu_cep,fkcampus_codigo,fktdu_codigo,usu_data_cadastro,usu_rg,usu_matricula) values 
                        ('".$_REQUEST['usu_nome']."','".$_REQUEST['usu_cpf']."','".md5($_REQUEST['usu_senha'])."',
                         '".$_REQUEST['usu_nivel']."','".$_REQUEST['usu_email']."','".$_REQUEST['usu_sexo']."',
                         '".$_REQUEST['usu_data_nasc']."','".$_REQUEST['usu_celular']."','".$_REQUEST['usu_telefone']."',
                         '".$_REQUEST['usu_endereco']."','".$_REQUEST['usu_numero']."','".$_REQUEST['usu_cidade']."','".$_REQUEST['usu_uf']."',
                         '".$_REQUEST['usu_cep']."','".$_REQUEST['fkcampus_codigo']."','".$_REQUEST['fktdu_codigo']."',
                         '".$_REQUEST['usu_data_cadastro']."','".$_REQUEST['usu_rg']."','".$_REQUEST['usu_matricula']."')";
			if ($this->resultado = $this->con->banco->Execute($sql))
			{
	  ...
	  {	       
	        $sql = "update usuarios set USU_NOME = '".$_REQUEST['usu_nome']."', USU_CPF = '".$_REQUEST['usu_cpf']."',
                        USU_SENHA = '".md5($_REQUEST['usu_senha'])."', USU_NIVEL = '".$_REQUEST['usu_nivel']."',
                        USU_EMAIL = '".$_REQUEST['usu_email']."', USU_SEXO ='".$_REQUEST['usu_sexo']."', 
                        USU_DATA_NASC ='".$_REQUEST['usu_data_nasc']."', USU_CELULAR ='".$_REQUEST['usu_celular']."',
                        USU_TELEFONE ='".$_REQUEST['usu_telefone']."', USU_ENDERECO = '".$_REQUEST['usu_endereco']."', 
                        USU_NUMERO ='".$_REQUEST['usu_numero']."', USU_CIDADE ='".$_REQUEST['usu_cidade']."', 
                        USU_UF ='".$_REQUEST['usu_uf']."', USU_CEP ='".$_REQUEST['usu_cep']."', 
                        FKCAMPUS_CODIGO ='".$_REQUEST['fkcampus_codigo']."', FKTDU_CODIGO = '".$_REQUEST['fktdu_codigo']."',
                        USU_DATA_CADASTRO ='".$_REQUEST['usu_data_cadastro']."', USU_RG ='".$_REQUEST['usu_rg']."', 
                        USU_MATRICULA ='".$_REQUEST['usu_matricula']."' WHERE USU_CODIGO = ".$_REQUEST['usu_codigo'];
			if ($this->resultado = $this->con->banco->Execute($sql)){
	  ...
	  function usuarios_pesquisar(){
               $busca = $_POST['busca'];
               $sql =("SELECT * FROM usuarios WHERE USU_NOME like'%$busca%' or USU_CPF like'%$busca%' and USU_CODIGO=".$_SESSION['codigo'] );
               $this->resultado = $this->con->banco->Execute($sql);
           }
