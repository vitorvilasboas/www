...
<div id="pagina">
   ...
   <?php if($_SESSION['tipo_usuario']=='1'){?>     
        <form class="formulario" action="usucom.php?pc=questionario_acao&acao=estudantes" method="post" enctype="multiparm/form-data">              
               <table class="tabelas">
   ...
   <?php } elseif($_SESSION['tipo_usuario']=='2'){?>     
        <form class="formulario" action="usucom.php?pc=questionario_acao&acao=docentes" method="post" enctype="multiparm/form-data">              
               <table class="tabelas">
                   <input type="hidden" name="categoria" value="<?php echo $_REQUEST['perfil'];?>" />
                        <tr>
   ...
   <?php } elseif($_SESSION['tipo_usuario']=='3'){?>     
        <form class="formulario" action="usucom.php?pc=questionario_acao&acao=tecnicos_adm" method="post" enctype="multiparm/form-data">              
               <table class="tabelas">
                   <input type="hidden" name="categoria" value="<?php echo $_REQUEST['perfil'];?>" />
                        <tr>
                            <th class="th276t">Informe o seu campus.</th>
