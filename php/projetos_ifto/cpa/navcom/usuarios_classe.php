...
class usuarios_classe 
  {
	  ...
	  {	       
	        $sql = "update usuarios set  USU_EMAIL = '".$_REQUEST['usu_email']."', USU_SEXO ='".$_REQUEST['usu_sexo']."', USU_DATA_NASC ='".$_REQUEST['usu_data_nasc']."', USU_CELULAR ='".$_REQUEST['usu_celular']."', USU_TELEFONE ='".$_REQUEST['usu_telefone']."', USU_ENDERECO = '".$_REQUEST['usu_endereco']."', USU_CIDADE ='".$_REQUEST['usu_cidade']."', USU_UF ='".$_REQUEST['usu_uf']."', USU_CEP ='".$_REQUEST['usu_cep']."' WHERE USU_CODIGO = ".$_SESSION['codigo'];
			   if ($this->resultado = $this->con->banco->Execute($sql))
			   {
