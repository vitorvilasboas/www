...
function valida_cpf(obj){
	...
	for (i = 0; i < cpf.length - 1; i++)
         ...
         <script type="text/javascript">
            ...
            function atualizaContador()
                {var hoje = new Date();
                    ...
                    var faltam = '';faltam += (dd && dd > 1) ?'<b>FALTAM, '+dd+' DIAS </br>' : (dd==1 ? '1 DIA, ' : '</br>');
                    faltam += (toString(hh).length) ? hh+'HS : ' : '';faltam += (toString(mm).length) ? mm+'M : ' : '';faltam += ss+'S';
        ...
        <title>Encontro do PIBID/IFTO</title>
    </head>
