		...
		echo '<div class="image_error">O usuário foi cadastrado  com sucesso! Acesse agora as informações do evento!<br />
		  ...
		  'Erro ao Cadastrar, mais informações entre em contato com vilsonsoares@ifto.edu.br';
            ...
            <table class="tabelas">
                ...
                <tr>
                    <td class="th276t">Data Nasc.:* </td><td class="td700"><span id="sprytextfield5"><input class="input_200" type="text" name="usu_data_nasc" /><span class="textfieldRequiredMsg">Campo obrigatório.</span><span class="textfieldInvalidFormatMsg">data inválido.</span></span></td>
                </tr>
                <tr>
