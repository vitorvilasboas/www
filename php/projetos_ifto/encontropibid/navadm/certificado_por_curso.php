                ...
                <h1 class="titulo1">Emitir Certificado</h1>
                       ...
                       <?php } ?>
                        ...
                        <?php
                             ...
                             $sql2=("select  usu_codigo,usu_nome from usuarios inner join  itens_minicursos on  IC_USU_CODIGO= USU_CODIGO where IC_MCSO_CODIGO='".$_REQUEST['mcso_codigo']."' order by USU_NOME");
                         ...
                         ?>
                           <tr>
                                ...
                                <td class="td100"><img src="imagens/marcar_f2.png" /><input class="input_radio" type="checkbox" name="usuarios[]" value="<?php echo $registros2->USU_CODIGO;?>"/></td>                      
                          </tr> 
                         <?php
                            }
                         ?>
