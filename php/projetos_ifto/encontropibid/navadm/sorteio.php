<?php 
    ...
    $sql = 'select usu_codigo,usu_nome from usuarios inner join caixa on part_usu_codigo = usu_codigo where part_ano = 2014';                        
        ...
        <div id="esquerda"> 
            <h1>Sorteio</h1>
              <div class="sorteiobarra">
                ...
                document.getElementById("information").innerHTML="Aguarde.. '.$i.' % concluído.";
                </script>';
