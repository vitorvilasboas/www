               ...
               <table class="tabelas">
                ...
                <table class="tabelas">
                  ...
                  <tr>                      
                    ...
                    while($registro=$resultado->FetchNextObject()){        
                    ?>                                
                          <td class="td800"><a href="ver_certificado.php?&opcao=part_evento&usu_codigo=<?php echo $registro->USU_CODIGO;?>"><?php echo 'Ano da Participação  '.$registro->PART_ANO;?></a> </td>                     
                  </tr> 
                   <?php
                   }
                  ?>
