<div id="pagina">
    <form class="formulario" action="ver_certificado_edFhistart.php?&opcao=part_evento&edicao=II&ano=2012" target="_blank" width="845" heigth="595" method="post">
        <h1 class="titulo1">Certificado II FHISTART</h1>
        <table class="tabelas">
            <tr>
