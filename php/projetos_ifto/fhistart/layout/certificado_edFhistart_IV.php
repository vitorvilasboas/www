...
<div id="pagina">
    <form class="formulario" action="ver_certificado_edFhistart.php?&opcao=part_evento&edicao=IV&ano=2014" target="_blank" width="845" heigth="595" method="post">
        <h1 class="titulo1">Certificado IV FHISTART</h1>
        <table class="tabelas">
            <tr>
