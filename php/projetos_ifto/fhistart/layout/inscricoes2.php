<div id="pagina">
        ...
        <form class="formularioEquipe" method="post" action="">
            <?php 
...
if($cont_usuarios >= '1'){
     echo '<div class="image_error">O usuário já esta cadastrado! Obrigado!<br />
           <a href="admin/index.php">Acessar os Mini-cursos</a>
           </div><!--enviado-->';
}else{
	...
	$sql_cad_usuarios .= "VALUES ('$usu_nome', '$usu_cpf', '".base64_encode($usu_senha)."', '$usu_nivel','$usu_status','$usu_email', '$usu_sexo', '$usu_data_nasc', '$usu_celular', '$usu_telefone', '$usu_endereco', '$usu_cidade', '$usu_uf', '$usu_cep', '$usu_instituicao', '$usu_modalidade', '$usu_portador', '$usu_data_cadastro')";
