...
if(isset($_POST['recuperar'])){
    if (($_POST['usu_cpf'] != '') && ($_POST['usu_email'] != '')){
	   ...
	   require "Connections/conecta.php";
           ...
           $usu_senha ='';
           $texto = 'Recuperação de senha do Flisol 2013';
           $contato = $usu_email;          
	   ...
	   if($registros = $resultado->FetchNextObject()){
               ...
               ."A sua senha é : A1b2C3d4E5";                         
              
               mail($contato,$texto,$msg,$headers);
               $sql="update usuarios set USU_SENHA = '".md5('A1b2C3d4E5')."' where USU_CPF='$usu_cpf' and USU_EMAIL='$usu_email'";
               $resultado = $con->banco->Execute($sql);
