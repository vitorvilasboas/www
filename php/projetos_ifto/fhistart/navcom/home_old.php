...
<script language="javascript" type="text/javascript">
                    ...
                    function novo_integrante() {
                        contador++;
                        var  novoscampos =  '<tr class="tr_int_'+contador+'"><td class="td350novo"><input class="input_350" type="text" id="int_'+contador+'_nome" name="int_'+contador+'_nome"/></td>';
                             novoscampos += '<td class="td150novo"><select class="input_150" id="int_'+contador+'_atribuicao" name="int_'+contador+'_atribuicao" onchange="habilita();"><option value=""></option><option value="Suporte">Suporte</option><option value="Cantor/Interprete">Cantor/Interprete</option><option value="Expositor">Expositor</option><option value="Produção/Vídeo">Produção/Vídeo</option></select></td>';
                             novoscampos += '<td class="td300novo"><select class="input_300_new" id="int_'+contador+'_curso" name="int_'+contador+'_curso" ><option value=""></option><option value="Licenciatura em Ciências Biológicas">Licenciatura em Ciências Biológicas</option><option value="Licenciatura em Computação">Licenciatura em Computação</option></select></td>';
                             novoscampos += '<td class="td100novo"><select class="input_100" id="int_'+contador+'_periodo" name="int_'+contador+'_periodo" ><option value=""></option><option value="1º">1º</option><option value="3º">3º</option><option value="5º">5º</option><option value="7º">7º</option></select></td>';
