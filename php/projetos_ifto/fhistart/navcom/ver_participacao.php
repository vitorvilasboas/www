            ...
            <form class="formulario" method="post" action="">
               <table class="tabelas">
                  <tr>
                    ...
                    ?>                                
                          <td class="td800"><a href="ver_certificado.php?&usu_codigo=<?php echo $registro->USU_CODIGO;?>&mcso_codigo=<?php echo $registro->MCSO_CODIGO;?>"><?php echo $registro->MCSO_TITULO;?></a> </td>                     
                  </tr> 
                   <?php
                          }
