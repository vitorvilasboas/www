...
<div id="pagina">                                                      
            <form class="inscricao" method="post" action="">
               <h1>Mini-Cursos que vou participar!</h1>
                    <?php
               ...
               <table class="ver_minicursos">  
                    <tr border='1'>
                        <td class="td100">Horario</td><td class="td140"> <?php echo $registro->MCSO_HORARIO;?></td><td class="td100"> Palestrante</td><td class="td470"> <?php echo $registro->MCSO_CONDUTOR;?></td>
                    </tr>
                    <tr>
