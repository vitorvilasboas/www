...
<tr><td colspan="4"><label> Curso : <?php echo $registro->MCSO_TITULO; ?></label></td></tr>
...
<?php } ?>
 ...
 ?>
    ...
    <tr>
        <th><?php echo $registro->USU_CODIGO;?></th><td><?php echo fullUpper($registro->USU_NOME);?></td><td><?php echo $registro->IC_SITUACAO;?></td><td>.</td>
    </tr>
      <?php
        }
      ?>
