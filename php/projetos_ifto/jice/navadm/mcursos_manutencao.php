             ...
             <div class="busca_manutencao">
               ...
               <table class="tabelas">
                    <tr>
                        ...
                        <td class="td70"><?php if($opcao->registros->MCSO_VALOR=='0.00'){echo '<span> Gratuito </span>';} else {echo '<span>'.$opcao->registros->MCSO_VALOR.'</span>';} ?></td>                     
                    ...
                    <tr>
                        ...
                        <td class="td800" colspan="7"><?php echo $opcao->registros->MCSO_TITULO;?></td>
                    </tr>
                    <tr>
                        <th class="th130t">Professor:</th>
                        <td class="td600" colspan="5"><?php echo $opcao->registros->MCSO_CONDUTOR;?></td>
                    ...
                    <tr >                          
                        <th class="th130t">Resumo:</th><td class="td800" colspan="7"><?php echo $opcao->registros->MCSO_RESUMO;?></td>
                    </tr>
                    <tr>
                        <td class="tdespaco" colspan="7">_</td>
                    </tr>
               </table>
               <?php
