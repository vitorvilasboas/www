        ...
        <table class="tabelas" > 
           ...
           while($opcao->registros = $opcao->resultado->FetchNextobject())
           {
            ...
            <tr>               
                ...
                <td class="tdlink"><a href="usuadm.php?pa=periodicos_acao&acao=alterar&per_codigo=<?php echo $opcao->registros->PER_CODIGO;?>"><img src="imagens/editar2.png"/>&nbsp;&nbsp;Alterar</a></td>
            ...
            <tr>
                ...
                <td class="td800" colspan="4"><?php echo $opcao->registros->PER_TITULO;?></td>	
            </tr>
            <tr>
                <th class="th176t">Autores:</th>
                <td class="td800" colspan="4"><?php echo $opcao->registros->PER_AUTORES;?></td>	
            </tr>
            <tr>
                <th class="th176t">Palavras-chave:</th>
                <td class="td800" colspan="4"><?php echo $opcao->registros->PER_PAL_CHAVE;?></td>	
            </tr>
            <tr>
                <th class="th176t">Resumo:</th>
                <td class="td800" colspan="4"><?php echo $opcao->registros->PER_RESUMO;?></td>	
            </tr>
            <tr>
