            ...
            <form class="formulario" method="post" action="">              
               ...
               <table class="tabelas">  
                    ...
                    <tr>
                        ...
                        <td class="td800" colspan="4"> <?php echo $opcao->registros->MCSO_TITULO;?></td>

                    </tr>
					    
					    <th class="th130t">Situação</th>
                        <td class="td500" colspan="2"> <?php echo '<span>'.$opcao->registros->IC_SITUACAO.'</span>';?></td>
						<th class="th100t">Valor R$</th>
                ...
                <?php    
                    ...
                    $data = date('Y');
                    $sql=("select sum(mcso_valor) as soma FROM itens_minicursos INNER JOIN usuarios ON IC_USU_CODIGO = USU_CODIGO INNER JOIN minicursos ON IC_MCSO_CODIGO = MCSO_CODIGO WHERE MCSO_ANO='$data' and USU_CODIGO = '".$_SESSION['codigo']."'");
