...
class PhocaGalleryViewCategory extends JViewLegacy
{
	...
	function display($tpl = null) {
		...
		$this->tmpl['photoswipe_display_caption']= $this->params->get( 'photoswipe_display_caption', 0 );
	...
	/*	if (!empty ($this->category->image)) {
		...
		$this->tmpl['ebc'] = '<div style="text-align:right;color:#ccc;display:block"><a href="https://www.phoca.cz/phocagallery"></a></div>';
