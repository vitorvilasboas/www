...
<!-- Intro image -->
	...
	<?php if (isset($images->image_intro) && !empty($images->image_intro)) : ?>
        ...
        <a class="img-intro" href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid)); ?>"> 
...
<!-- More -->
	<?php if ($params->get('show_readmore') && $this->item->readmore) :
		...
		?>
		<a class="btn btn-info readmore" href="<?php echo $link; ?>">
