...
//Texto dinamico
$texto = '         Declaro para os devidos fins de titulação que '
        .$nome.', portador'.$s.' do CPF nº '.$cpf.', '.$tipo.', é '.$tipo_participacao.' do projeto '
...
$texto2 = 'O projeto está sendo acompanhado por esta coordenação.';
