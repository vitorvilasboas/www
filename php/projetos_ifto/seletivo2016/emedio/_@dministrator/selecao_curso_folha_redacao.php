...
?>
      <h2 style="text-align:center; color: #cc0000;">ADMINISTRA&Ccedil;&Atilde;O</h2><br>
        <fieldset style="background-color: #FFFFFF; border: 1px solid #000000; width: 600px">
        	<legend align=center class="text_medio_caps_color">FOLHA DE REDA&Ccedil;&Atilde;O</legend>            

				 	<form name="selecao_curso" class="formulario" method="post" action="relatorio_folha_redacao.php" target="_blank">
                        <table width="650">
                          <tr>
