...
function inscricaoEmail($email, $cpf, $inscricao, $nome, $concurso){
//function enviarEmail(){
  ...
  require ("config/conectaBanco.php");
        ...
        $mail->Subject = 'Inscrição cadastrada';
        $mail->Body = "Olá ".$nome.", <br /><br /> Sua inscrição no ".$concurso." foi registrada com sucesso.";
        $mail->Body .= "Seu número de Inscrição é <b>".$inscricao."</b>.<br /><br />Acesse a área do candidato para ter acesso a maiores informações sobre sua inscrição.<br /><br />";
