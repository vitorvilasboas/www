            ...
            <form name="alterarInscricao" method="post" action="alteraInscricaoConfirmar.php?go=alter">
              ...
              <div class="div_bloco">
                <fieldset class="borda_radius">
                  ...
                  <div class="div_linha">
                    <div><label for="part_cota">Op&ccedil;&atilde;o de L&iacute;ngua Estrangeira*:</label>
                        <select style="width:595px;" class="campos_form_fim_ln" size="1" name="lingua_can" id="lingua_can" >
                          <option value="">Escolha a op&ccedil;&atilde;o de L&iacute;ngua estrangeira*</option>
                          <option value="$_SESSION['lingua_logado']" selected><?php echo $_SESSION['lingua_logado']; ?></option>
                          <?php
                            if($_SESSION['lingua_logado'] == 'ESPANHOL' ){
                              echo "<option value=\"INGLES\">INGL&Ecirc;S</option>\n";
                            } else {
                ...
                <fieldset class="borda_radius">
                  ...
                  <div class="div_linha" style="height:100px;" id="desateesp_can">
                    <div><label for="desateesp_can">Descreva como dever&aacute; ser o atendimento especial que necessita para realizar a prova:</label>
                      <textarea style="width:595px; height:70px;" class="campos_form_fim_ln" name="desateesp_can" rows="3"><?php echo $_SESSION['atespecdesc_logado']; ?></textarea>
                    </div>
                  </div>
                </fieldset>
              </div>
